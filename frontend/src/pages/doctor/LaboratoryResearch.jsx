...
const LaboratoryResearch = () => {
  ...
  const handleSaveResult = async () => {
    ...
    try {
      ...
      let researchType = researchTypes.find(t => t.name === newResult.researchTypeName.trim() && t.category === 'laboratory');
  ...
  const selectedType = researchTypes.find(t => t.name === newResult.researchTypeName && t.category === 'laboratory');

  if (loading) return <PageLayout><div className="loading-spinner">Загрузка...</div></PageLayout>;

  return (
    <PageLayout title={`Лабораторные исследования - ${patient?.name || 'Пациент'}`} hideBack={false}>
          ...
          <div className="research-form">
            ...
            <div className="form-group">
              ...
              <input
                ...
                list="lab-research-types"
                required
              />
              <datalist id="lab-research-types">
                {researchTypes
                  .filter(type => type.category === 'laboratory')
                  .map(type => (
