...
module.exports = function(consultationController) {
  ...
  router.post('/api/chats/doctor', authMiddleware, validate(consultationSchemas.createDoctorChat), asyncHandler((...args) => consultationController.createDoctorChat(...args)));
